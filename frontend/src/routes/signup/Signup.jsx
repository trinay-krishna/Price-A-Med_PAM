...
const Signup = () => {
  ...
  async function handleClick(direction) {
    ...
    if (currentStep === 0) {
      ...
      const response = await axios.get(BACKEND_URL + "/api/validate/signup", {
    ...
    // -----------------------------------------------------------------------------------------------------------------------
      ...
      const response1 = await axios.get(BACKEND_URL + "/api/validate/otp", {
      ...
      const response2 = await axios.post(
        BACKEND_URL + "/api/producer/signup",
        data
      );
      console.log(
